  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserProfileRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserProfileRow> profileSettingsUserProfileRowList = snapshot.data!;
              ...
              child: Column(
                ...
                children: [
                            ...
                            child: Padding(
                              ...
                              child: FutureBuilder<List<UserProfileRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<UserProfileRow> imageUserProfileRowList =
                                      snapshot.data!;

                                  return ClipRRect(
                                    borderRadius: BorderRadius.circular(60.0),
                                    child: Image.network(
                                      imageUserProfileRowList
                                          .firstOrNull!.photo!,
                                      width: 100.0,
                                      height: 100.0,
                                      fit: BoxFit.cover,
                  ...
                  Padding(
                    ...
                    child: Text(
                      valueOrDefault<String>(
                        profileSettingsUserProfileRowList
                  ...
                  Padding(
                    ...
                    child: Text(
                      valueOrDefault<String>(
                        profileSettingsUserProfileRowList.firstOrNull?.email,
                        'N.A',
                      ),
